...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backdropBlur: {
        'md': '40px', // Adjust blur intensity
      },
      colors: {
        'glass-bg-light': 'rgba(255, 255, 255, 0.5)',
        'glass-bg-dark': 'rgba(51, 51, 51, 0.5)',
      },
    },
  },
  future: {
  ...
  plugins: [
    require('@tailwindcss/forms'),
    require('@tailwindcss/container-queries'),
    require('@tailwindcss/backdrop'), // Add this plugin for backdrop utilities
  ],
};
